...
console.log(`Total usuarios con suscripción activa: ${emailArray.length}`);
console.log('\nPrimeros 10 emails:');
emailArray.slice(0, 10).forEach(email => console.log(`  - ${email}`));

// Generar el archivo whitelist.js
const whitelistContent = `// Lista de usuarios con suscripción ACTIVA en YinYangSEO Academy
// Generado automáticamente desde academy.csv el ${new Date().toLocaleDateString('es-ES')}
